...
namespace Avtomat_Bandit
{
    ...
    {
        int balance = 1000000; //Исходный баланс.
        ...
        private void Init_Counter(decimal counter)
        {
            ...
            label4.Text = "Баланс: руб   " + balance;
            counter_try = 10;
            label6.Text = "Осталось попыток: " + counter_try;
        }
        ...
        private void Upd_Win_Money(int number)
        {
            ...
            DialogResult result = MessageBox.Show("Вы выиграли: руб" + win_money, "Поздравляем!", MessageBoxButtons.OK, MessageBoxIcon.Warning); //Выыодим поздравления.
            balance = balance + win_money; //Прибавляем выигрыш к балансу
            label4.Text = "Баланс: руб  " + balance; //Выводим обновленный балансе
